...
namespace AlgorithmsPractice.Codility.Lesson7_StacksAndQueues
{
    ...
    The height of the wall is specified by an array H of N positive integers. H[I] is the height of the wall from I to I+1 meters to the right of its left end. In particular,
    ...
    {
        public static int GetNumberOfBlocks(int[] skyline)
        {
